  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="harga_beli" name="diskon" value="<?php if(isset($row['diskon'])) echo $row['diskon']; ?>" type="text" class="form-control">
      </div>
    </div>
  </div>
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="stok" name="iuran" value="<?php if(isset($row['iuran'])) echo $row['iuran']; ?>" type="text" class="form-control">
      </div>
    </div>
  </div>
  <div class="form-group row">
